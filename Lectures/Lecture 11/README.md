...
## Making games in Python: Basics
* It requires `pygame` Python Library which contains necessary and essential functionalities, to be used during game development
